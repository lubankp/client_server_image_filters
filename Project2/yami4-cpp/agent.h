...
public:
    ...
    {
        std::unique_ptr<details::incoming_message_dispatcher_base> object(
    ...
    /// is detected.
    std::unique_ptr<outgoing_message> send(
    ...
    outgoing_message_id send(
        ...
        bool auto_connect = true)
    {
        std::unique_ptr<details::outgoing_message_dispatcher_base>
    ...
    {
        std::unique_ptr<details::connection_event_dispatcher_base> monitor(
    ...
    {
        std::unique_ptr<details::io_error_dispatcher_base> logger(
